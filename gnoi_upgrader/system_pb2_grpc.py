...
class SystemStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Traceroute = channel.unary_stream(
                ...
                request_serializer=system__pb2.TracerouteRequest.SerializeToString,
                response_deserializer=system__pb2.TracerouteResponse.FromString,
                )
        self.Time = channel.unary_unary(
                '/gnoi.system.System/Time',
                request_serializer=system__pb2.TimeRequest.SerializeToString,
                response_deserializer=system__pb2.TimeResponse.FromString,
                )
        self.SetPackage = channel.stream_unary(
                '/gnoi.system.System/SetPackage',
                request_serializer=system__pb2.SetPackageRequest.SerializeToString,
                response_deserializer=system__pb2.SetPackageResponse.FromString,
                )
        self.SwitchControlProcessor = channel.unary_unary(
                '/gnoi.system.System/SwitchControlProcessor',
                request_serializer=system__pb2.SwitchControlProcessorRequest.SerializeToString,
                response_deserializer=system__pb2.SwitchControlProcessorResponse.FromString,
                )
        self.Reboot = channel.unary_unary(
                '/gnoi.system.System/Reboot',
                request_serializer=system__pb2.RebootRequest.SerializeToString,
                response_deserializer=system__pb2.RebootResponse.FromString,
                )
        self.RebootStatus = channel.unary_unary(
                '/gnoi.system.System/RebootStatus',
                request_serializer=system__pb2.RebootStatusRequest.SerializeToString,
                response_deserializer=system__pb2.RebootStatusResponse.FromString,
                )
        self.CancelReboot = channel.unary_unary(
                '/gnoi.system.System/CancelReboot',
                request_serializer=system__pb2.CancelRebootRequest.SerializeToString,
                response_deserializer=system__pb2.CancelRebootResponse.FromString,
                )
...
def add_SystemServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Traceroute': grpc.unary_stream_rpc_method_handler(
                    servicer.Traceroute,
                    request_deserializer=system__pb2.TracerouteRequest.FromString,
                    response_serializer=system__pb2.TracerouteResponse.SerializeToString,
            ),
            'Time': grpc.unary_unary_rpc_method_handler(
                    servicer.Time,
                    request_deserializer=system__pb2.TimeRequest.FromString,
                    response_serializer=system__pb2.TimeResponse.SerializeToString,
            ),
            'SetPackage': grpc.stream_unary_rpc_method_handler(
                    servicer.SetPackage,
                    request_deserializer=system__pb2.SetPackageRequest.FromString,
                    response_serializer=system__pb2.SetPackageResponse.SerializeToString,
            ),
            'SwitchControlProcessor': grpc.unary_unary_rpc_method_handler(
                    servicer.SwitchControlProcessor,
                    request_deserializer=system__pb2.SwitchControlProcessorRequest.FromString,
                    response_serializer=system__pb2.SwitchControlProcessorResponse.SerializeToString,
            ),
            'Reboot': grpc.unary_unary_rpc_method_handler(
                    servicer.Reboot,
                    request_deserializer=system__pb2.RebootRequest.FromString,
                    response_serializer=system__pb2.RebootResponse.SerializeToString,
            ),
            'RebootStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.RebootStatus,
                    request_deserializer=system__pb2.RebootStatusRequest.FromString,
                    response_serializer=system__pb2.RebootStatusResponse.SerializeToString,
            ),
            'CancelReboot': grpc.unary_unary_rpc_method_handler(
                    servicer.CancelReboot,
                    request_deserializer=system__pb2.CancelRebootRequest.FromString,
                    response_serializer=system__pb2.CancelRebootResponse.SerializeToString,
            ),
    }
...
class System(object):
    ...
    def Traceroute(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/gnoi.system.System/Traceroute',
            system__pb2.TracerouteRequest.SerializeToString,
            system__pb2.TracerouteResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Time(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gnoi.system.System/Time',
            system__pb2.TimeRequest.SerializeToString,
            system__pb2.TimeResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetPackage(request_iterator,
        ...
        return grpc.experimental.stream_unary(request_iterator, target, '/gnoi.system.System/SetPackage',
            system__pb2.SetPackageRequest.SerializeToString,
            system__pb2.SetPackageResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SwitchControlProcessor(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gnoi.system.System/SwitchControlProcessor',
            system__pb2.SwitchControlProcessorRequest.SerializeToString,
            system__pb2.SwitchControlProcessorResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Reboot(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gnoi.system.System/Reboot',
            system__pb2.RebootRequest.SerializeToString,
            system__pb2.RebootResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RebootStatus(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gnoi.system.System/RebootStatus',
            system__pb2.RebootStatusRequest.SerializeToString,
            system__pb2.RebootStatusResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CancelReboot(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gnoi.system.System/CancelReboot',
            system__pb2.CancelRebootRequest.SerializeToString,
            system__pb2.CancelRebootResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
